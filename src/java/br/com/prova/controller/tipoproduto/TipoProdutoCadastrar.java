 ...
 */
package br.com.prova.controller.tipoproduto;

import br.com.prova.dao.GenericDAO;
import br.com.prova.dao.TipoProdutoDAO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.cadastrar(oTipoProduto)){
                ...
                mensagem = "Problemas ao cadastrar TipoProduto. Verifique os dados e tente novamente! ";
            }
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("TipoProdutoListar");
        } catch (Exception e) {
            System.out.println("Problemas no Servelet ao cadastrar TipoProduto! Erro: "+ e.getMessage());
        }
    }
